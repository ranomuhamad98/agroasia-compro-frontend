...
export function useProductManagement() {
  ...
  const createProduct = async (payload: CreateProductPayload) => {
    try {
      ...
      const response = await apiClient.post<ApiSuccessWrapper<ProductCreateResponseBody>>('/product/post', {
        body: payload,
      });
  ...
  const addProductImage = async (productId: string, payload: AddProductGalleryPayload) => {
    try {
      ...
      const response = await apiClient.post<ApiSuccessWrapper<any>>(`/product/${productId}/gallery`, {
        body: payload,
      });
  ...
  const updateProduct = async (
    ...
    try {
      ...
      const response = await apiClient.put<{ success: boolean; data: any; message?: string }>(`/product/${id}`, {
        body: payload,
      });
  ...
  const getProductDetail = async (id: string) => {
    try {
      ...
      const response = await apiClient.get<{ success: boolean; data: any; message?: string }>(`/product/${id}`);
  ...
  const deleteProduct = async (id: string) => {
    try {
      ...
      const response = await apiClient.delete<{ success: boolean; data: any; message?: string }>(`/product/${id}`);
