        ...
        <li>
          <div class="tp-postbox-details-comment-box d-sm-flex align-items-start">
            ...
            <div class="tp-postbox-details-comment-content">
              ...
              <p>By defining and following internal and external processes, your team will have clarity on resources to
                <br> attract and retain customers for your business.</p>
            </div>
          </div>
          <ul class="children">
            <li>
              <div class="tp-postbox-details-comment-box d-sm-flex align-items-start">
                ...
                <div class="tp-postbox-details-comment-content">
                  ...
                  <p>By defining and following internal and external processes, your team will have clarity on resources
                    to <br> attract and retain customers for your business.</p>
                </div>
              </div>
            </li>
          </ul>
