<template>
  <section class="tp-cta-area fix pt-50 p-relative z-index-1">
    <div class="tp-cta-inner p-relative pt-80 pb-55" style="background-color: #678E61" data-bg-color="#678E61">
        <div class="tp-cta-shape">
          <img class="tp-cta-shape-1" src="/images/cta/shape/cta-shape-1.png" alt="">
          <img class="tp-cta-shape-2" src="/images/cta/shape/cta-shape-2.png" alt="">
        </div>
        <div class="container">
          <div class="row">
              ...
              <div class="col-lg-6">
                <div class="tp-cta-thumb">
                    ...
                    <img src="/images/cta/cta-thumb-1.jpg" alt="">
                </div>
