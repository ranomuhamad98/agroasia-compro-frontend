          ...
          >
            <div class="cartmini__thumb">
              <nuxt-link :href="`/product-details/${item.id}`">
                <img :src="item.images[0]" alt="cart-img" width="70" height="60" />
              </nuxt-link>
            </div>
            <div class="cartmini__content">
              ...
              <div class="cartmini__price-wrapper">
                ...
                >
                  ${{((Number(item.price) - (Number(item.price) * Number(item.discount)) / 100) * item.orderQuantity).toFixed(2)}}
                </span>
